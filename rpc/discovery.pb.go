...
func init() {
	...
	proto.RegisterType((*VersionResponse)(nil), "rpc.VersionResponse")
}
...
func (c *discoveryServiceClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingResponse, error) {
	...
	err := grpc.Invoke(ctx, "/rpc.DiscoveryService/Ping", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *discoveryServiceClient) Version(ctx context.Context, in *VersionRequest, opts ...grpc.CallOption) (*VersionResponse, error) {
	...
	err := grpc.Invoke(ctx, "/rpc.DiscoveryService/Version", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DiscoveryService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rpc.DiscoveryService/Ping",
	}
...
func _DiscoveryService_Version_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rpc.DiscoveryService/Version",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _DiscoveryService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "rpc.DiscoveryService",
...
var fileDescriptor0 = []byte{
	...
	0x62, 0x2e, 0x2a, 0x48, 0x56, 0xe2, 0xe5, 0xe2, 0x0e, 0xc8, 0xcc, 0x4b, 0x0f, 0x4a, 0x2d, 0x2c,
	...
	0x20, 0xa7, 0x08, 0x09, 0xe8, 0x15, 0x15, 0x24, 0xeb, 0x21, 0x39, 0x52, 0x4a, 0x10, 0x49, 0x04,
	0xea, 0x04, 0x13, 0x2e, 0x76, 0xa8, 0xab, 0x84, 0x84, 0xc1, 0xb2, 0xa8, 0xae, 0x96, 0x12, 0x41,
	0x15, 0x84, 0xe8, 0x72, 0x62, 0x8d, 0x02, 0x85, 0x01, 0x20, 0x00, 0x00, 0xff, 0xff, 0xb2, 0x2c,
	0x1b, 0x44, 0x1e, 0x01, 0x00, 0x00,
}
