...
func TestCalculateBlockHash(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			nonce:  18193,
			output: buildTransactionId("0000d9bbb68fc04dd2b5f34999a35fdf753abfd260d4541967e87e519696a2eb"),
		},
		{
			header: entity.NewBlockHeader(
				0,
			...
			nonce:  27764,
			output: buildTransactionId("0000e61eeb820f5d29e9a2149adb396f4405963ecc0159f6cec52c8de1fbf672"),
		},
		{
			header: entity.NewBlockHeader(
				2,
				buildTransactionId("0000745031d715be942d0fc2731fd0f4b4edd340bad2de76a2fa98368be53419"),
				[]*entity.Transaction{
					{
			...
			nonce:  25634,
			output: buildTransactionId("000012f029d52582ed6f179f7b949a0eca1e4f3f7115898de1c15c42ac576f42"),
		},
	}
