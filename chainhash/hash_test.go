...
func TestNewHashFromStr(t *testing.T) {
	...
	for index, testParams := range tests {
		err := hashTestSuite(testParams.in, testParams.want, testParams.err, index)
		if err != nil {
			t.Error(err)
		}
	}
...
func hashTestSuite(input string, expectedResult Hash, expectedError error, index int) error {
